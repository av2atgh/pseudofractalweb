...
with a log-evidence growing as $(\ln 2)\,n$ \cite{vazquez2026ringwantsbroken}.
...
$\mathbb{Z}_2$ symmetry exchanging the two branches of block~$2$. 
The block sizes and the within/between edge counts are
...
for the partition of the ring \cite{vazquez2026ringwantsbroken}. A numerical fit of the discrete slope
...
degree-corrected structure, not necessarily its global optimum.
...
$t=5$ ($n=366$) to $+15$ at $t=6$ ($n=1095$) to $+506$ at $t=7$ ($n=3282$)---that $r_\kappa=1095$ for every
certainty level up to $q\simeq 1-10^{-5}$ and every prior $\alpha$. Under degree correction the web
...
Together with the companion ring calculation \cite{vazquez2026ringwantsbroken}, these results extend the exactly
...
accompanying open-source script at 
\href{https://github.com/av2atgh/pseudofractalweb}{github.com/av2atgh/pseudofractalweb},
and the closed-form edge and degree counts
